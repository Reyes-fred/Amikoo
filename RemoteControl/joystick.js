...
function sendStateUpdate () {  
  ...
  client.publish('amikoo/state', 'true')
}
...
function periodicActivity() {
   if(pinup.read()==0){
    client.publish('amikoo/moveforward','true');
    console.log("Message is published");    

   }else if(pindown.read()==0){
    client.publish('amikoo/movebackward','true');
    console.log("Message is published");    

   }else if(pinleft.read()==0){
    client.publish('amikoo/moveleft','true');
    console.log("Message is published");    

   }else if(pinright.read()==0){
    client.publish('amikoo/moveright','true');
    console.log("Message is published");    

   }else if(select.read()==0){
    client.publish('amikoo/movestop','true');
    console.log("Message is published");    
